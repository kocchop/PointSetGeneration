...
if __name__=='__main__':
    ...
    showpoints(np.random.rand(10000,3),green,red,blue,magnifyBlue=4)
    # [showpoints(np.random.rand(10000,3),green,red,blue,magnifyBlue=2,waittime=10) for i in xrange(10000)]
