...
tensorflow = /home/mdl/mzk591/anaconda3/envs/haabu/lib/python2.7/site-packages/tensorflow/include
...
depthestimate/tf_nndistance_g.cu.o: depthestimate/tf_nndistance_g.cu
	$(nvcc) -D_GLIBCXX_USE_CXX11_ABI=0 -std=c++11 -c -o depthestimate/tf_nndistance_g.cu.o depthestimate/tf_nndistance_g.cu -I $(tensorflow) -isystem /usr/local/cuda-8.0/include -DGOOGLE_CUDA=1 -x cu -Xcompiler -fPIC -O2
